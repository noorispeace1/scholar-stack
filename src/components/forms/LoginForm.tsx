  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 mb-8 text-center">
        ...
        <p className="text-purple-200/50 text-sm">Sign in to your account to continue</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="flex items-center justify-between pt-2">
          <Link href="#" className="text-sm font-medium text-purple-400 hover:text-purple-300 transition-colors hover:underline">
            Forgot Password?
          </Link>
        </div>
        ...
        >
          ...
          {isSubmitting ? (
            ...
            <>
              Sign In <ArrowRight className="h-4 w-4 opacity-70 group-hover:translate-x-1 transition-transform" />
            </>
          )}
        </motion.button>
      </form>
      ...
      <div className="mt-8 text-center text-sm">
        <span className="text-purple-200/50">Don't have an account? </span>
        <Link href="/register" className="text-purple-400 hover:text-purple-300 font-bold transition-colors hover:underline">
          Sign up now
        </Link>
      </div>
    </motion.div>
