...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#070814] p-4 sm:p-8 relative overflow-hidden">
      ...
      <div className="absolute top-[-20%] right-[-20%] w-[60%] h-[60%] rounded-full bg-[radial-gradient(circle,_rgba(124,58,237,0.15)_0%,_rgba(0,0,0,0)_70%)] blur-[80px] pointer-events-none" />
      <div className="absolute bottom-[-20%] left-[-20%] w-[60%] h-[60%] rounded-full bg-[radial-gradient(circle,_rgba(79,70,229,0.15)_0%,_rgba(0,0,0,0)_70%)] blur-[80px] pointer-events-none" />
